## North Ebranan Item Tables

Due to the different economic conditions in North Ebrana and the relative isolation of Valarus from Ulfos, the items available for sale are different. Items that are available are priced differently. Also, different items can only be purchased in certain establishments. The items are broken down into Prostoi, Kommersant, millitary, and specialty. 
...
| Fishing tackle           | 1gp   |
| Bandage                  | 2cp   |
| Pick, miners (bronze)    | 2gp   |
| Animal feed              | 2cp   |
| Fresh rations (1 day)    | 2cp   |
| Iron rations (1 day)     | 1sp   |
...
| Scythe (bronze)          | 4gp   |
| Sling                    | 1sp   |
| Sling bullets (50)       | 4cp   |
| Shenchai (jug)           | 3cp   |
| Shenchai (cup)           | 0.5cp |
| Bread (loaf)             | 1cp   |
| Fried fish               | 2cp   |
| Beetroot soup (bowl)     | 2cp   |
| Flour (sack)             | 1cp   |
...
| Bundle of rosemary sage     | 10gp  |
| Spring water (flask)        | 2gp   |
| Abacus                      | 2gp   |
| Ball bearings (bag of 1000) | 5gp   |
| Bell                        | 3gp   |
| Book                        | 25gp  |
| Candle                      | 1sp   |
...
| Coal (1 pound bag)          | 5sp   |
| Vestaments                  | 5sp   |
| Hammer                      | 3gp   |
| Hammer, sledge              | 6gp   |
| Holy Symbol                 | 1gp   |
| Golden Holy Symbol          | 40gp  |
| Amulet                      | 5gp   |
| Emblem                      | 5gp   |
| Reliquary                   | 5gp   |
| Hourglass                   | 10gp  |
...
| Ladder (10-foot)            | 1sp   |
| Lamp                        | 5sp   |
| Lantern, bullseye           | 20gp  |
| Lantern, hooded             | 10gp  |
| Lock                        | 20gp  |
| Magnifying glass            | 100gp |
| Mirror, steel               | 5gp   |
| Oil (1 liter flask)         | 2sp   |
| Paper (one sheet)           | 2sp   |
...
| Tools, Tinker's             | 20gp  |
| Tools, Smiths               | 30gp  |
| Tools, Lockpicking          | 50gp  |
| Tools, Carpentry            | 15gp  |
| Utsensils, Cooking          | 10gp  |
| Vial                        | 1gp   |
| Whetstone                   | 1cp   |
| Pitcher, fancy              | 1sp   |
| Waterskin                   | 2sp   |
...
| Potion of Fearlessness      | 200+5d20gp  |
| Potion of Quick-footed-ness | 600+10d20gp |
